...
export default function DeleteRoomConfirm({ roomId, roomNumber, onClose }: { roomId: number, roomNumber: string, onClose: () => void }) {
      ...
      <div className="w-full max-w-sm bg-white border border-rose-100 rounded-[2.5rem] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300">
        <div className="p-10 text-center space-y-6">
          ...
          <div className="space-y-2">
            <h3 className="text-2xl font-black text-slate-900 font-outfit tracking-tight">Delete Room {roomNumber}?</h3>
            <p className="text-slate-500 font-medium">This action cannot be undone. All beds in this room will be removed from the database.</p>
          </div>
